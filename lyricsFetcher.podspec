#
#  Be sure to run `pod spec lint lyricsFetcher.podspec' to ensure this is a
...
LyricsFetcher is a command tool to fetch lyrics server for windows or unix.This library	contains useful tool about: fileCtrl,threadpool,audioTag,stringConv... 
  ...
  s.author             = { "liaogang" => "ynwlgh@icloud.com" }
  # Or just: s.author    = "liaogang"
  # s.authors            = { "liaogang" => "ynwlgh@icloud.com" }
  # s.social_media_url   = "http://twitter.com/liaogang"
  ...
  s.source       = { :git => "https://github.com/liaogang/lyricsFetcher.git", :tag => "v0.0.1" }
